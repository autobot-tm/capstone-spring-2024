...
const ShowAllImage = () => {
  ...
  return (
    <CustomModal width={800} nameOfModal={showAllImageModal} title={null} action={closeShowAllImageModal} footer={null}>
      <Row gutter={[8, 8]}>
        {images.map((image, index) => {
          return (
            <Col md={12} xs={24} key={index}>
              <LazyLoadImage effect="blur" src={image} width="100%" height="290px" style={{ objectFit: 'cover' }} />
            </Col>
          );
        })}
      </Row>
